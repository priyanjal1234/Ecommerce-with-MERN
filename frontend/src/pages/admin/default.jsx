...
const AdminPanel = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-[#111827] flex flex-col items-center pt-10 pb-5  text-white">
      ...
      <div>
        ...
        <p className="text-gray-400 text-center mt-2">
          Add or update products in your inventory
        </p>
      </div>
      <div className="bg-gray-800 rounded-lg shadow-xl p-6 mt-8">
        ...
        <Link to={'/all-products'} className="text-sm block mt-3 text-purple-600">See All Products</Link>
      </div>
    </div>
  );
};
